...
import {TfiClose} from "react-icons/tfi"
 ...
 const Navbar = () => {
  ...
  return (
    <div className={menu ? "main flex flex-row justify-between items-center pt-3 font-bold text-sm" : "main flex flex-row justify-between items-center pt-3 font-bold blur-sm text-sm"}>
        ...
        <div className="hidden lg:inline justify-center pl-20 pr-4">
            <ul className="flex flex-row-reverse text-[#171a20] hover:cursor-pointer">
                <li  onClick={onMenu} className="leading-5 py-2 px-4 hover:bg-black/5 rounded transition duration-700">Menu</li>
        ...
        <div className="bg-white right-0 top-0 w-72 h-full z-10 absolute lg:hidden">
