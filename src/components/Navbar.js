...
import {TfiClose} from "react-icons/tfi"
    ...
    function menu_click(){
        document.getElementsByClassName('main').classList.add('blur-sm');
    }

const Navbar = () => {
  return (
    <div className="main flex flex-row justify-between items-center pt-3 font-bold text-sm">
        ...
        <div className="hidden lg:inline justify-center pl-20 pr-4">
            <ul className="flex flex-row-reverse text-[#171a20] hover:cursor-pointer">
                <li  onClick={menu_click} className="leading-5 py-2 px-4 hover:bg-black/5 rounded transition duration-700">Menu</li>
